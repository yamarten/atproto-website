...
const navTranslations: Record<string, Record<string, string>> = {
  ja: {
    ...
    '/guides/permission-requests': '権限リクエスト',
    '/guides/permission-sets': '権限セット',
    '/guides/oauth-patterns': 'OAuthパターン',
    '/guides/scope-builder': 'スコープビルダー',
    ...
    '/guides/installing-lexicons': 'Lexiconを用いた開発',
    ...
    '/guides/account-management': 'ユーザーアカウント',
